...
const PRESET_CANVAS_DATA = {
  'CANVAS-ROBBERY-10042': {
    ...
    edges: [
      { id: 're_1', source: 'sn_1', target: 'sn_2', label: 'Complainant Deposition', animated: true, style: { stroke: 'rgba(200,129,74,0.85)', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(200,129,74,0.85)' } },
      { id: 're_2', source: 'sn_1', target: 'sn_3', label: 'Incident Occurred At', animated: true, style: { stroke: 'rgba(82,176,224,0.85)', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(82,176,224,0.85)' } },
      { id: 're_3', source: 'sn_3', target: 'sn_4', label: 'Getaway Route (ORR)', animated: true, style: { stroke: 'rgba(180,82,224,0.85)', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(180,82,224,0.85)' } },
      { id: 're_4', source: 'sn_8', target: 'sn_4', label: 'Rider / Operates Bike', animated: true, style: { stroke: 'rgba(224,82,82,0.85)', strokeWidth: 2.5 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(224,82,82,0.85)' } },
      { id: 're_5', source: 'sn_9', target: 'sn_5', label: 'Snatched Handbag', animated: true, style: { stroke: 'rgba(224,200,82,0.85)', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(224,200,82,0.85)' } },
      { id: 're_6', source: 'sn_8', target: 'sn_6', label: 'Seized 10g Gold Chain', animated: true, style: { stroke: 'rgba(224,200,82,0.85)', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(224,200,82,0.85)' } },
      { id: 're_7', source: 'sn_9', target: 'sn_7', label: 'Possessed Stolen S23', animated: true, style: { stroke: 'rgba(82,224,122,0.85)', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(82,224,122,0.85)' } },
      { id: 're_8', source: 'sn_8', target: 'sn_10', label: 'Chargesheet Filed', animated: true, style: { stroke: 'rgba(200,129,74,0.85)', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(200,129,74,0.85)' } },
      { id: 're_9', source: 'sn_9', target: 'sn_10', label: 'Chargesheet Filed', animated: true, style: { stroke: 'rgba(200,129,74,0.85)', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(200,129,74,0.85)' } },
      { id: 're_10', source: 'sn_1', target: 'sn_8', label: 'Arrested ARR-3301', animated: true, style: { stroke: 'rgba(224,82,82,0.85)', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(224,82,82,0.85)' } },
      { id: 're_11', source: 'sn_1', target: 'sn_9', label: 'Arrested ARR-3302', animated: true, style: { stroke: 'rgba(224,82,82,0.85)', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: 'rgba(224,82,82,0.85)' } }
    ]
  },
  ...
  return (
    <div style={{ width: '100%', height: 'calc(100vh - 64px)', position: 'relative', background: '#0a0a14' }}>
      ...
      <div style={{
        ...
        <button
          onClick={() => {
            const cid = currentCanvasId.includes('10042') ? '10042' : '1';
            navigate(`/predict?caseId=${cid}&station=PS-0006`);
          }}
          style={{
            background: 'linear-gradient(135deg, rgba(82,176,224,0.25), rgba(180,82,224,0.25))',
            color: '#38bdf8',
          ...
          title="View and forecast this case in Predictive Intelligence Engine"
        >

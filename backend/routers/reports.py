...
def generate_reportlab_pdf(case_data: dict, accused: list, victims: list, sections: list) -> bytes:
    ...
    story.append(Paragraph(f"PROJECT SENTINAL — CONFIDENTIAL — {datetime.now().strftime('%d %b %Y')}", body_style))
...
async def generate_case_report(case_id: int):
    ...
    <body>
      <div class="header">
        ...
        <p>PROJECT SENTINAL — CONFIDENTIAL INTEL REPORT</p>
      </div>
      ...
      <footer style="margin-top: 50px; border-top: 1px solid #eee; padding-top: 10px; font-size: 10px; color: #888; text-align: center;">
        Generated by Project Sentinal · Confidential Law Enforcement Platform
      </footer>
    </body>
    </html>
    """
...
4 0 obj<</Length 500>>
stream
BT /F1 18 Tf 50 740 Td (SENTINAL - CASE REPORT) Tj
...
async def generate_district_report(district_name: str):
    ...
    <body>
      <div class="header">
        <h1>PROJECT SENTINAL — DISTRICT INTELLIGENCE AGGREGATION</h1>
      ...
      <footer style="margin-top: 40px; font-size: 9px; color: #888; text-align: center;">
        Generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} · Project Sentinal
      </footer>
    </body>
    </html>
    """
...
4 0 obj<</Length 600>>
stream
BT /F1 16 Tf 50 760 Td (SENTINAL - DISTRICT INTELLIGENCE REPORT) Tj
